//
//  LiveStudiesViewController.swift
//  MacResearch
//
...
class LiveStudiesViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func getStudyArray() {
        StudyService.getStudies(status: .live, completion: {
            (json, error) in
