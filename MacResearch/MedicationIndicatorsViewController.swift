//
//  MedicationIndicatorsViewController.swift
//  MacResearch
//
...
class MedicationIndicatorsViewController: UIViewController, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        medicationsList = ["Head Injury", "Headaches", "Tension-Type Headaches"]
